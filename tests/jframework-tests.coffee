...
#    test.equal lst.toArr(), [0, 1, 2, 3]
#
#Tinytest.add "AutoVar - don't unpack nested AutoVars in .get", (test) ->
#    x = new J.Var 5
...
#    lst = J.List [0, 1, a]
#    test.isTrue lst.get(2) isnt 5
#    autoDict = J.AutoDict(
#        -> ['a']
#        -> a
#    )
#    test.isTrue autoDict.get('a') isnt 5
#    autoList = J.AutoList(
#        -> 1
#        -> a
#    )
#    test.isTrue autoList.get(0) is a
#
