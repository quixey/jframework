###
    NOTES
    What to do when stuff is unexpectedly killed during Flush?
    Do we really need to nail the flush queue's order?
###
...
Tinytest.add "xxx", (test) ->
    ...
    window.b = J.AutoVar 'b',
        -> a.get() + 1

    a = window.a = J.AutoVar 'a',
        -> v.get() + 1

    console.log b.get()


#Tinytest.add "AutoVar - equilibrium values", (test) ->
#    firstRun = J.Var true
#    runCount = 0
#
#    a = J.AutoVar 'a', ->
...
#    firstRun.set false
#    test.equal a.get(), 10
#    test.equal runCount, 11
#    # FIXME: This test shouldn't actually work
#    test.isTrue false, "This test shouldn't actually work, we're not
#        building a constraint solver here."
#
#
...
#            c = J.AutoVar 'c', ->
#                if v.get() is 6
#                    console.warn "for sure gonna crash"
#                    try
#                        w.get()
#                        console.log 'didnt crash 2'
#                    catch e
#                        console.log 'yep crashed #2', e
#                        throw e
#                8
#
#            w = J.AutoVar 'w', -> v.get()
...
#    # sort.
#    console.warn "Probably gonna crashed"
#    try
#        test.equal a.get(), 3
#        console.warn "Didn't crash!"
#    catch e
#        console.warn "yep crashed", e
#
#
...
#    console.info "CREATOR", d._fields['j']
